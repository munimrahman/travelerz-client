    ...
    <div className="bg-eee py-4">
      <div className="container rounded bg-white shadow py-4 px-4">
              ...
              <tr>
                ...
                <td className="col-2 text-center v-align">
                  <button
                    ...
                    className="btn btn-outline-danger shadow-none fw-bold px-2 py-0"
                  >
                    X
                  </button>
                </td>
                ...
                <td colSpan="5">
                  <div className="container text-center">
                    <div className="alert alert-danger" role="alert">
                      No items in your Cart. Please Select a Package From{" "}
                      <Link
                        to="/packages"
                        className="primary-text fw-bold text-decoration-none alert-hover"
                      >
                        Our Packages!
                      </Link>
                    </div>
              ...
              <td colspan="2">
                <div className="d-flex">
                  <input
                    ...
                    name=""
                    id=""
                    className="form-control w-25 me-2 shadow-none"
                  />
                  <button className="btn shadow-none custom-btn px-3 py-2 rounded-pill">
                    Apply Coupon
                  </button>
                </div>
              </td>
        ...
        <div className="row align-items-center">
          ...
          <div className="col-12 col-md-2 fw-bold fs-4 text-center">- OR -</div>
          <div className="col-12 col-md-5">
