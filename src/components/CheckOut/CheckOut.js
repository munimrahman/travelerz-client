...
const CheckOut = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://travelerz-server.vercel.app/packages/byKeys", {
      method: "POST",
  ...
  const onSubmit = (data) => {
    ...
    data.item = { cart };
    fetch("https://travelerz-server.vercel.app/orders", {
      method: "POST",
      headers: { "content-type": "application/json" },
      ...
      <div className="container rounded bg-white shadow py-4 px-4">
        ...
        {cart.length > 0 ? (
          <div>
            ...
            {displayCoupon && (
              <div className="border rounded row shadow py-4 mx-0 my-3">
                <p className="ps-3">
                ...
                <div className="col-12 col-md-6">
                  <button className="btn custom-btn py-2 px-3 shadow-none rounded-pill">
                    Apply Coupon
                  </button>
                </div>
              </div>
            ...
            <div className="border rounded my-4 p-3">
              <div className="form-check">
                ...
                {pay === "cash" && (
                  <p className="border shadow-sm p-2 rounded w-75 mt-2">
                    You can pay in cash when you visited our site!
                  </p>
                )}
              </div>
              <div className="form-check">
              ...
              <div className="form-check">
                ...
                {pay === "card" && (
                  <div className="border shadow-sm p-3 rounded w-75 mt-2">
                    <p>
                      Pay with your credit card via Stripe. TEST MODE ENABLED.
                      In test mode, you can use the card number 4242424242424242
                      with any CVC and a valid expiration date or check the
                      Testing Stripe documentation for more card numbers.
                    </p>
                    <div className="row">
                      <div className="col-12 my-3">
                        <label htmlFor="cardBumber" className="my-1">
                          Card Number *
                        </label>{" "}
                        <br />
                        <input
              ...
              <div className="text-end">
                <Link onClick={handleSubmit(onSubmit)}>
                  <button
                    ...
                    className="btn shadow-none custom-btn py-3 px-4 rounded-pill px-3 py-2"
                  >
                    PLACE ORDER
                  </button>
                </Link>
          ...
          <div className="w-75 mx-auto mt-3 text-center">
            <div className="alert alert-danger py-5 fs-4" role="alert">
              Your Cart Empty! Select Package From{" "}
              <Link
                to="/packages"
                className="primary-text text-decoration-none alert-hover"
              >
                Our Packages!
              </Link>
            </div>
